- an [[agora abstract]].
	- #push [[agora abstracts]]
		...
		- An Agora is a [[distributed knowledge graph]] provisioned and maintained by a community as a [[commons]].
			- Whereas a [[personal knowledge graph]] usually contains resources authored or collected by a single person, and a wiki usually contains resources produced by a group, an Agora contains an integration of voice-preserving personal and group resources.
			...
			- Whereas known projects in the space tend to be centralized[[social knowledge graph]] and
