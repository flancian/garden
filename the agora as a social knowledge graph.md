- an [[agora abstract]].
	- #push [[agora abstracts]]
		...
		- An Agora is a [[distributed knowledge graph]] provisioned and maintained by a community as a [[commons]].
			- Whereas a [[personal knowledge graph]] usually contains resources authored or collected by a single person, and a wiki usually contains resources produced by a community, an Agora a [[social knowledge graph]] and contains on the [[integration]] of both personal and group resources in a social [[context]].
