...
- #push [[matrix]]
	- [[agora matrix bot]]
		...
		- after dinner I'll see if there's already a [[matrix activitypub bridge]] out there :) there probably is, which would means it could be modified to dump activities to disk if it doesn't have that functionality yet. this yields [[agora writing]]. [[agora reading]] can be had by adding 'send once' functionality to [[agora server]].
		-