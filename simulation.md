...
- a [[thing]].
	...
	- What if things [[isomorphic]] to each other are, in a way, near each other in the multiverse? If the fact that they are the same shape means they are near to each other in the [[library of babel]], or that of [[mendel]]?