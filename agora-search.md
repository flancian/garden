...
- The [[agora]] is in essence equivalent to a [[distributed]] [[wiki]]. 
  - Note you could theoretically use a wiki to crowdsource search results; in the limit, think of having a wiki page for every likely user query. Presumably the same applies here.
