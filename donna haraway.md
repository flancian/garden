...
Eso es lo que he llamado cultivar la respons-habilidad. Ir de visita no es una práctica heroica, armar un alboroto no es la  Revolución, pensar unos con otros no es el Pensamiento. Abrir versiones para que las historias puedan continuar es tan mundano,  tan ligado a la tierra... Este es el punto, precisamente
```
