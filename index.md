...
The following might be interesting nodes to serve as entry points to this garden.
  ...
  - #go: this is an Agora action that marks URLs as canonical for a given node. It lets users jump to the URL marked as canonical for the topic in question. It is an example of an [[Agora action]] which [[redirects]] to these URLs on demand.
