...
Put simply, [[go links]] are named bookmarks -- strings of text (usually slugged, but not necessarily) associated with URLs by users in a community. 
...
An example would suffice. You could reme
