...
[[Agora protocol]] can be used within any [[Agora platform]] to enable the community to provision a [[Agora commons]]. We[^author] provide a reference implementation of such a platform, and an example knowledge commons.
