...
Building on the above and [[free software]], we model and detail how to implement a distributed system that provisions social knowledge services. Then we analyze some of these services and other potential applications of this system. Finally, we shortly explore possible social implications and future work.
