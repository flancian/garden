...
In this [[chapter]] we describe the [[Agora]], a [[protocol]] and [[platform]] yielding a [[knowledge commons]] provisioned by a self-governing community for the [[public good]]. This commons is built around a [[distributed knowledge graph]] assembled from off-the-shelf components respecting user choice and data sovereignty.
