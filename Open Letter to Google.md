...
***Note: as of the time of writing ([[2024-05-03]], [[2024-05-07]], [[2024-05-09]], ...), this letter should be considered most definitely a [[work in progress]]. I started writing in this node on [[April 29th]] with the intent to have a short essay in readable state on the first week of [[May 2024]] (depending on how work and personal life went), but then I decided to make it my month-scoped priority and to take the opportunity to write also the internal proposal. Note I have covered many of these topics before, as fragments, elsewhere in the [[Agora]]; please reach out if you have any questions or comments :).***
...
I write this set of optimistic, some would say [[naive]], **proposals** knowingly in the context of what some call [[late stage capitalism]] and can safely be alternatively described as [[digital capitalism]] as it is as of mid [[2024]]. So I need to clarify that my chances of success, I realize, are low. Yet I, as a Google employee, still want to try and  communicate my recommendations as clearly and as ethically as possible to both company and society. Because of this, the rest of this letter for now will be available in a forum available only to Google employees.
