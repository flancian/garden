...
The [[Agora]], in short, is what I call my umbrella proposal, presented as a [[prototype]], to help fix Google and similar systems. That is, I make the argument that the project I started personally and then developed as an informal 120% since around 2020 (see [[Agora project]]), represents a step forward in the right direction as we navigate the mid 20s together. You, [[dear reader]], will be the judge of the merit of these my claims.
