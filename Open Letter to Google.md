...
Instead so far I have seen the date go by mostly unnoticed. People (some out, some in the company) seem jaded by the context, as if Google has lost their trust and can now be expected to [[do no better]] than other corporations; to act just as other corporations do, despite our [[founders letter]] being our public declaration of intentions. The base for which users, and stockholders, decided to trust Google early on.
